...
const StorybookSVG = (props: SvgProps) => (
  <Svg height={height(4)} width={width(18)} viewBox="0 0 512 512" {...props}>
    <Path
      fill={Colors.dark}
      d="M356.5,5.2L353.9,63c-0.1,3.2,3.7,5.2,6.3,3.2l22.6-17.1L401.9,64c2.5,1.7,5.8,0,6-3l-2.2-58.8l28.4-2.2
